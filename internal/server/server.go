...
import (
	...
	"github.com/mouse233/MySekaiMapper/internal/har"
...
// Config defines upload limits and report endpoint configuration.
type Config struct {
	MaxTotalSize  int64
	MaxChunkSize  int64
	MaxChunks     int
...
// UserIDFromURL extracts a numeric player ID from a /user/<digits> path.
